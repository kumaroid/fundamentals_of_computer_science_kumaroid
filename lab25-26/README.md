...
<b>Преподаватель:</b> <ins>асп. каф. 806 Сахарин Никитa Александрович</ins>
...
## 4. Оборудование:
<b>Процессор:</b> 11th Gen intel(R) Core(TM) i5-9400H @ 2.70GHz<br/>
<b>ОП:</b> 16 ГБ<br/>
<b>SSD:</b> 512 ГБ<br/>
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| 1 | дом. | 16.06.23 | 18:00 | Выполнение лабораторной работы | - | - |

## 10. Замечания автора по существу работы

<a href = 'https://codeforces.com/contest/1843/submission/210436475'>def(Zaschita)</a>
